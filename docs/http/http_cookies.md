...
此预防措施有助于缓解[跨站点脚本](https://developer.mozilla.org/en-US/docs/Web/Security/Types_of_attacks)攻击
...
- 禁止追踪 Do-Not-Track
  ...
  查看[`DNT`](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Headers/DNT) 以获取更多信息
