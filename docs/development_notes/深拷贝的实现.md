...
对于其他的也要实现深拷贝的，比较麻烦的属性对应的数据类型，JSON.stringify 暂时还是无法满足的，那么就需要下面的几种方法了
...
这种基础版本的写法也比较简单，可以应对大部分的应用情况, 但为了“拯救”这些缺陷，下面我们来看看改进的版本, 针对上面几个待解决问题, 先通过四点相关的理论来想想解决办法
...
针对上面这几个问题，我们来看下改进后的递归实现的深拷贝代码应该是什么样子的，如下所示
